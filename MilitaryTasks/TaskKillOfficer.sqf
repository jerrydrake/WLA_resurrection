...
_nul = [_head, _toChoose,"S",[["V17","JinN51","JinN52"],["V18","JinN9","JinN10","JinN14"],["V40"]],(missionnamespace getvariable "CivC")] SPAWN FConversationDialogSol;
//TASK TAKEN
waitUntil {sleep 0.5; scriptdone _nul};
if (isNil"LineSelected") exitWith {};
if (LineSelected == 0) then {
_n = 2 SPAWN TASK_OFFICER;
} else {
//ANOTHER TASK
