...
_desc = "CSAT are blocking NATO Army vehicles to go ashore at this pier. Taking out CSAT zones inside 2km radius would bring some NATO armored vehicle zones to this area.";
if !(_isWater) then {_desc = "CSAT are blocking NATO Army vehicles to enter the AO through this passage. Taking out CSAT zones inside 2km radius would bring some NATO armored vehicle zones to this area.";};
[
WEST, // Task owner(s)
...
[_someId, "onEachFrame", {
	...
	drawIcon3D ["\A3\Structures_F_Heli\VR\Helpers\Data\VR_Symbol_Heli_Weapons_CA.paa", ICONCOLORBLUE, _this,1.51, 1.51, 0, (format ["Clear CSAT Zones inside 2km Radius: %1m",round (_this distance player)]), 1, SAOKFSI, "TahomaB"];
