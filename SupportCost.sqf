...
case "AFRF Ammo": {_price = 200;};
case "AFRF Gear": {_price = 600;};
case "AFRF Launchers": {_price = 700;};
case "AFRF Special Weapons": {_price = 600;};
case "AFRF Weapons": {_price = 600;};
case "USF Ammo": {_price = 200;};
case "USF Gear": {_price = 600;};
case "USF Launchers": {_price = 700;};
case "USF Special Weapons": {_price = 600;};
case "USF Weapons": {_price = 600;};
...
case "NATO SF weapons": {_price = 600;};
case "Russian weapons": {_price = 600;};
