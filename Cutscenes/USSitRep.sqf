// This task is to participate to a SitRep with NATO command. it is given from file "MainTasks\Resistance2.sqf". At the end of this task the task SAOKUSREQ in file "TaskEvents.sqf" is given.
