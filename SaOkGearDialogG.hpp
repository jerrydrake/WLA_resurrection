...
{
	idc = 1800;
	text = "Glasses Selection"; //--- ToDo: Localize;
...
class RscListbox_1500: RscListbox
{
	...
	onMouseButtonDblClick = "(lbText [1500, (lbCurSel 1500)]) CALL SAOKGEARGCHANGE;closeDialog 0;[] SPAWN SAOKGEARG;false";
	};
class RscButton_1600: RscButton
{
	...
	w = 4.5 * GUI_GRID_W;
	h = 1 * GUI_GRID_H;
	action = "(lbText [1500, (lbCurSel 1500)]) CALL SAOKGEARGCHANGE;closeDialog 0;[] SPAWN SAOKGEARG;";
};
