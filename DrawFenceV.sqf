private ["_d","_NRun","_runW","_funcRun","_funcH","_start","_end","_objectType","_dir","_dirO","_obj","_objs","_bBox","_p1","_p2","_maxWidth","_maxLength","_maxHeight","_hh","_hos","_lastPos","_hole","_tt","_total","_h","_totalL","_id","_datAr","_alN"];
...
//_gPper = if (count _this > 4) then {_this select 4} else {1000};  Land_Mil_WiredFenceD_F Land_Mil_WiredFence_F
...
_wTm set [2,0];
//_obj setvectorup (surfaceNormal (getposATL _obj)); Land_IndFnc_9_F
